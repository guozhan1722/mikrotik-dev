...
function showdata()
{
	...
	var showdatastatechange = function(req)
	{
		...
		if (arr[1] == 161)
		{
			document.getElementById("channel153").checked = false;
			document.getElementById("channel161").checked = true;
		} else {
			document.getElementById("channel153").checked = true;
			document.getElementById("channel161").checked = false;
		}
...
{
	if (radio.value == 'channel153') {document.getElementById("channel161").checked = false;document.getElementById("channel153").checked = true;}
	if (radio.value == 'channel161') {document.getElementById("channel153").checked = false;document.getElementById("channel161").checked = true;}
}
...
function savedata()
{
	...
	var channel = document.getElementById("channel153").checked ? "153":"161";
